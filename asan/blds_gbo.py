...
if __name__ == "__main__":
    ...
    if args.host_32_clang:
        ...
        subprocess.call(["/mnt/bcb7778e-e87e-4609-857b-cada2826a487/llvm/cmake_build/bin/clang", "-g", "-fno-omit-frame-pointer", "-fsanitize=address", "gbo_recover.c", "-o", "gbo_host_32_clang_asan"])
        subprocess.call(["/mnt/bcb7778e-e87e-4609-857b-cada2826a487/llvm/cmake_build/bin/clang", "-g", "-fno-omit-frame-pointer", "-fsanitize-recover=address", "gbo_recover.c", "-o", "gbo_host_32_clang_asan_recover"])
        subprocess.call(["/mnt/bcb7778e-e87e-4609-857b-cada2826a487/llvm/cmake_build/bin/clang", "-g", "-fno-omit-frame-pointer", "-fsanitize=address", "-fsanitize-blacklist=blacklist.txt", "gbo_recover.c", "-o", "gbo_host_32_clang_asan_black"])
        sys.stdout.write("done\n")
