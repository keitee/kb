...
//
// keitee@keitee-mint:~/Qt/Examples/Qt-5.12.3/dbus/chat$ pkg-config --libs
// --cflags dbus-1
//
...
int main()
{
  ...
  /*
     ...
     detecting if your application is already running and had reserved a bus
     name unless somebody stole this name from you, so better to choose a
     correct bus name
     */
  {
