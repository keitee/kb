	...
	, m_signalled(false)
{
	...
	EXPECT_TRUE(m_dbusConn.connect("", objPath,
	                               "org.freedesktop.DBus.Properties", "PropertiesChanged",
	                               "sa{sv}as",
	                               this, SLOT(onPropertyChangeSignal(const QString&, const QVariantMap&, const QStringList&))));
...
void DBusPropertyChangeSpy::onPropertyChangeSignal(const QString &interfaceName,
