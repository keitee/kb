...
namespace pearl_produce_without_duplicates
{
  ...
  // first k positive integers. This extreme data set won't alter the run time
  // of the bitmap method by much, but it might skew the run time of a system
  // sort. How could you generate a file of k unique random integers between 0
  // and n-1 in random order? Strive for a short program that is also efficient.
  // -- 
  //
  // Here, we are faced with the challenge of avoiding duplicates. Column 12
  // is a must-read to solve this exercise the good way. It introduces very
