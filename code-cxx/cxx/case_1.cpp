...
int main()
{
  const char xx[]{"JnZnY2Fzc2V0aWQ9RjY3MzA3QURBMTYxNEMzNUEwQkE0REUzOUYyMjI3MiZ2"
                  "Z2N0b2tlbj0wMDAw\n"};
  std::cout << "xx len: " << sizeof(xx) << ", strlen: " << strlen(xx)
            << std::endl;
