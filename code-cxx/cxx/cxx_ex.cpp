...
TEST(PatternObserver, sendNotificationWithCallerDispatcherButRaiseException)
{
  using namespace cxx_observer_notifier_full;
  ...
  // TestObserverUseSharedFromThis o;
  // o.subscribe();

  std::shared_ptr<TestObserverUseSharedFromThis> o =
    std::make_shared<TestObserverUseSharedFromThis>();
